...
function Tenants({ selectedTenant, onSelectTenant }) {
  ...
  // const handleTenantClick = (tenant) => {
  //   console.log('Clicked Tenant ID:', tenant.id); // Log the tenant ID for debugging
  //   onSelectTenant(tenant.id); // Pass the ID to trigger the API call in the parent component
  // };
